...
module.exports = {
    ...
    "homepage": "https://github.com/michieljoris/tw",
    ...
    "repository": {
        "type": "git",
        "url": "https://github.com/michieljoris/tw.git"
    },
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/tw/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called tw which is linked to
    //./bin/tw in the local package.

    //If we have installed this package globally using npm install tw
    //-g we will be able to call this new command tw from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/tw.js"
    },
    ...
    "scripts": {
        ...
        "docs": "node node_modules/.bin/docco src/tw.js"
    }
};
